...
User.create!(name:'Jingwei', email:'jingwei@ji.com', state:'New York', city: 'New York City', profession:'Student', description:'Hi, I am Jingwei. I am a boy!')AdminUser.create!(email: 'admin@example.com', password: 'password', password_confirmation: 'password')